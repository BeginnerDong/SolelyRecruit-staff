	...
	<div>
		...
		<div class="tixianBox radius10">
			<div class="addBtn bordB1 pdlr4">
				<div class="flexRowBetween bankmsg pdtb15" @click="Router.navigateTo({route:{path:'/pages/user_myBankCard_add/user_myBankCard_add'}})">
					<div>到账银行卡</div>
					<div class="flexCenter">
						<text class="color9 fs13">去添加</text>
						<image class="arrow arrowR" src="../../static/images/arrow-icon1.png" mode=""></image>
					</div>
				</div>
			</div>
...
<style>
	...
	.editMoney .input input::-ms-input-placeholder{font-size: 14px; color: red;}
